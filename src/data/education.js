export const education = [
    ...
    },
    {
      ...
      summary: [
        "Graduated Top 10 with Honors (4.63 GPA)",
        "VP of Beta Club · Secretary of Mu Alpha Theta & Science Honor Society",
        "Varsity Swim Team Captain · County Record Holder · State Qualifier",
      ],
      description: [
        "Graduated Top 10 in a class of 542 with Honors",
        "4.63 GPA · APs: Computer Science A, Calculus BC, Statistics, CSP, Chemisty, Microeconomics, Macroeconomics",
        "Named Most Outstanding Math Student in Senior Class",
        "Led volunteer initiatives: First Responder Fundraisers, Service League Support, Co-founded School Food Bank",
        "Member of Student Government, NHS, Key Club, and CFA Leader Academy",
        "Captain of Varsity Swim Team: Multiple State Qualifier, County Record in 400 Free Relay"
      ]
    }
  ]